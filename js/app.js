    ...
    function menuInit() {
        if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
            if (bodyLockStatus && e.target.closest(".icon-menu")) {
                ...
                if (document.querySelector(".menu__body")) document.querySelector(".menu__body").classList.toggle("_active");
            }
        }));
    }
...
***************************************************************************** */
    ...
    window.onload = function() {
        ...
        function documentActions(e) {
            ...
            if (window.innerWidth > 768 && isMobile.any()) {
                if (targetElement.closest(".menu__item")) {
                    resetAnyHover(targetElement.closest(".menu__body"), targetElement.closest(".menu__item"));
                    targetElement.closest(".menu__item").classList.toggle("_hover");
                }
                if (!targetElement.closest(".menu__item") && document.querySelectorAll(".menu__item._hover").length > 0) document.querySelectorAll(".menu__item._hover").forEach((elem => {
        ...
        function resetAnyHover(e, currE) {
            const elems = e.querySelectorAll("._hover");
            if (elems.length) elems.forEach((elem => {
                if (elem != currE) elem.classList.toggle("_hover");
            }));
        }
        ...
        function addToCart(productButton, productId) {
            if (!productButton.classList.contains("_hold")) {
                ...
                const productImage = product.querySelector(".item-products__img-ibg");
